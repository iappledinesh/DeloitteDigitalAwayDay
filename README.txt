This README file explains how to use the program which is an (Deloitte_Digital_Away_Day_Task)


Purpose
-----------

 This is a Java (Deloitte_Digital_Away_Day_Task) application.
...
-----------
  ...
  Extract the zipped file "DeloitteDigitalAwayDay.zip" into your desired location.
  
Go to your selected IDE, such as Eclipse or IntelliJ, and import the project (extracted zipped file) into your IDE

Run the main class "DeloitteDigitalAwayDay.main()" found in path src/main/java/com.dinesh.deloitte.code
...
-----------
 ...
 The main package is found in com.dinesh.deloitte.code and this contains four main parts: Exception handling, the model, the scheduler and the util
...
When the main class (DeloitteDigitalAwayDay) runs, starts its timer at 9am, it creates 2 teams, it goes into the file location picks the activities, 
